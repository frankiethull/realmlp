...
This repo is transposed from the standalone, default tuned, simplified, RealMLP implementation with Python found here: https://github.com/dholzmueller/realmlp-td-s_standalone/tree/main. This is a pure R torch implementation, without reticulate or Python dependencies, only R & torch are needed. 
...
## To-Do's
  - [x] create package & implement RealMLP-TD-S based on `dholzmueller/realmlp-td-s_standalone`
  - [x] export `Mish`
  ...
  - [ ] note subtle differences (such as sample vs population maths in numpy.std vs base::sd())